...
resource "aws_launch_template" "example" {
  ...
  image_id      = "ami-065a492fef70f84b1"  # Replace with your appropriate AMI ID
...
resource "aws_lb" "my_lb" {
  ...
  security_groups    = [aws_security_group.firewall.id]  # Referencing the security group
